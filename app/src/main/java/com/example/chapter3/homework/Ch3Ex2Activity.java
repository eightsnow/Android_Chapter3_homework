...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        scaleXAnimator.setDuration(Integer.valueOf(durationSelector.getText().toString()));
        ...
        scaleYAnimator.setDuration(Integer.valueOf(durationSelector.getText().toString()));
        ...
        alphaAnimator.setDuration(Integer.valueOf(durationSelector.getText().toString()));
